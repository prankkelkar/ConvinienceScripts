...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Beats/7.5.1/build_beats.sh
...
#PATCH_URL
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Beats/7.5.1/patch"
...
function configureAndInstall() {
	...
	curl -SLO https://storage.googleapis.com/golang/go1.12.9.linux-s390x.tar.gz
	...
	sudo python3 -m pip install appdirs pyparsing packaging setuptools wheel PyYAML termcolor ordereddict nose-timer MarkupSafe virtualenv
...
function fileChanges(){
	...
	curl $PATCH_URL/patch.diff > /tmp/patch.diff
	git apply --ignore-whitespace /tmp/patch.diff
